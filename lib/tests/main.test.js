...
//.........................................................................................................
  ...
  this["tunnels: hiding"] = async function(T, done) {
    var error, i, len, matcher, probe, probes_and_matchers;
    probes_and_matchers = [[['abcde', ['backslash'], 'abcdefghxyz'], 'cccdcedefghxyz', null], [['abcde', ['backslash'], 'abc\\defghxyz'], 'cccdceaB100befghxyz', null]];
//.........................................................................................................
...
//.....................................................................................................
  ...
  this["tunnels: hiding, reverting"] = async function(T, done) {
    var error, i, len, matcher, probe, probes_and_matchers;
    probes_and_matchers = [[['abcde', ['backslash'], 'abcdefghxyz'], 'abcdefghxyz', null], [['abcde', ['backslash'], 'abc\\defghxyz'], 'abcdefghxyz', null]];
//.........................................................................................................
// [['abc',null],null,'not a valid tunneltext_chrs',]
    for (i = 0, len = probes_and_matchers.length; i < len; i++) {
      [probe, matcher, error] = probes_and_matchers[i];
